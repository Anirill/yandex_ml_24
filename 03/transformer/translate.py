...
# checkpoint = torch.load("step7000_transformer_checkpoint.pth.tar")
checkpoint = torch.load("transformer_checkpoint.pth.tar")
...
def translate(source_sequence, beam_size=4, length_norm_coefficient=0.6):
    ...
    with torch.no_grad():
        ...
        while True:
            ...
            prev_word_indices = torch.div(unrolled_indices, vocab_size, rounding_mode='trunc')  # (k)
